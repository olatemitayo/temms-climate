...
export default function Weather() {
  ...
  return (
    <main className="">
      <div className="mx-auto  flex cmd:flex-col-reverse justify-between items-center px-[clamp(20px,3vw,40px)] py-[clamp(10px,2vw,16px)] max-w-[1500px]  ">
        <div className="w-[70%] cmd:w-[100%] max-h-[100%]    px-[clamp(20px,3vw,35px)] py-[clamp(10px,2vw,16px)] ">
          hiii
        </div>
